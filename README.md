...
- **Bare metal** performance for small matrix/tensor multiplications, contractions and tensor factorisations [LU, QR etc] using SIMD vectorisation. Refer to [benchmarks](https://github.com/romeric/Fastor/wiki/Benchmarks) to see how Fastor delivers performance on par with MKL JIT's dedicated API
