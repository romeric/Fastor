...
struct SIMDVector<double, 256> {
    ...
    static constexpr FASTOR_INDEX Size = internal::get_vector_size<double>::size;
    static constexpr FASTOR_INLINE FASTOR_INDEX size() {return internal::get_vector_size<double>::size;}
...
struct SIMDVector<double, 128> {
    ...
    static constexpr FASTOR_INDEX Size = internal::get_vector_size<double,128>::size;
    static constexpr FASTOR_INLINE FASTOR_INDEX size() {return internal::get_vector_size<double,128>::size;}
    static constexpr int unroll_size(FASTOR_INDEX size) {return (static_cast<int>(size) - static_cast<int>(Size));}
