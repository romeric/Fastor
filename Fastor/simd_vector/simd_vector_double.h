...
struct SIMDVector<double, simd_abi::avx512> {
    ...
    FASTOR_INLINE SIMDVector(const SIMDVector<double,simd_abi::avx512> &a) : value(a.value) {}
    ...
    FASTOR_INLINE SIMDVector<double,simd_abi::avx512> operator=(const SIMDVector<double,simd_abi::avx512> &a) {
        value = a.value;
        return *this;
    }
