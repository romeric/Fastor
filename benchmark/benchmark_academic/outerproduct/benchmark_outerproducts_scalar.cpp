...
// Tensor<T,Rest...,Rest...> iterate_over_scalar(const Tensor<T,Rest...> &a, const Tensor<T,Rest...>& b) {
//     size_t iter = 0;
//     Tensor<T,Rest...,Rest...> out;
//     for (; iter<NITER; ++iter) {
//         out = scalar_version::outer(a,b);
//         unused(out);
//         // further hack for gcc, seemingly  doesn't hurt performance of _crossproduct 
//         T *out_data = out.data();
//         out_data[1] += 1; 
...
void run() {
    ...
    Tensor<T,Rest...> a, b;
    a.random(); b.random();
    // timeit(static_cast<void (*)(const Tensor<T,Rest...> &, const Tensor<T,Rest...>&)>(&iterate_over_scalar<T,Rest...>),a,b);
    // timeit(static_cast<Tensor<T,Rest...,Rest...> (*)(const Tensor<T,Rest...> &, const Tensor<T,Rest...>&)>(&iterate_over_scalar<T,Rest...>),a,b);
...
int main() {
    ...
    print("Running Scalar benchmark\n");
