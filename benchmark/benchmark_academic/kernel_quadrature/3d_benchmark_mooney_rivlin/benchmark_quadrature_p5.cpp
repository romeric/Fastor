...
void run(const Tensor<Ti,nelem,nodeperelem> &elements, const Tensor<Tf,nnode,ndim> &points,
    ...
    for (int elem=0; elem<nelem; ++elem) {
        ...
        for (int g=0; g<ngauss; ++g) {
            ...
            // unused(MaterialGradient);
            // print(type_name<decltype(inverse(ParentGradientX))>());
...
FASTOR_NOINLINE void make_run() {
    ...
    std::string efile = "/home/roman/Dropbox/Fastor/benchmark/benchmark_academic/kernel_quadrature/meshes/mesh_hand_3d_elements_p5.dat";
    std::string pfile = "/home/roman/Dropbox/Fastor/benchmark/benchmark_academic/kernel_quadrature/meshes/mesh_hand_3d_points_p5.dat";
    std::string gfile0 = "/home/roman/Dropbox/Fastor/benchmark/benchmark_academic/kernel_quadrature/meshes/p5_3d_Jm.dat";
    std::string gfile1 = "/home/roman/Dropbox/Fastor/benchmark/benchmark_academic/kernel_quadrature/meshes/p5_3d_AllGauss.dat";
