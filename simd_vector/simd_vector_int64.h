...
struct SIMDVector<Int64,256> {
    ...
    static constexpr FASTOR_INDEX Size = internal::get_vector_size<Int64,256>::size;
    static constexpr FASTOR_INLINE FASTOR_INDEX size() {return internal::get_vector_size<Int64,256>::size;}
    ...
    FASTOR_INLINE SIMDVector<Int64> operator=(Int64 num) {
    ...
    FASTOR_INLINE SIMDVector<Int64> operator=(const SIMDVector<Int64> &a) {
        value = a.value;
        return *this;
    }
    ...
    FASTOR_INLINE void operator+=(const SIMDVector<Int64> &a) {
...
struct SIMDVector<Int64,128> {
    ...
    static constexpr FASTOR_INDEX Size = internal::get_vector_size<Int64,128>::size;
    static constexpr FASTOR_INLINE FASTOR_INDEX size() {return internal::get_vector_size<Int64,128>::size;}
    static constexpr int unroll_size(FASTOR_INDEX size) {return (static_cast<int>(size) - static_cast<int>(Size));}
