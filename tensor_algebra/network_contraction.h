...
struct extractor_contract<Index<Idx0...>, Index<Idx1...>, Index<Idx2...> > {
  template<typename T, size_t ... Rest0, size_t ... Rest1, size_t ... Rest2>
    ...
    contract_impl(const Tensor<T,Rest0...> &a, const Tensor<T,Rest1...> &b, const Tensor<T,Rest2...> &c) {
        ...
        //     return contraction<Index<Idx1...>,resulting_index_1>(b,tmp);
        // }
...
struct extractor_contract_4<Index<Idx0...>, Index<Idx1...>, Index<Idx2...>, Index<Idx3...> > {
  template<typename T, size_t ... Rest0, size_t ... Rest1, size_t ... Rest2, size_t ... Rest3>
    ...
    contract_impl(const Tensor<T,Rest0...> &a, const Tensor<T,Rest1...> &b, const Tensor<T,Rest2...> &c, const Tensor<T,Rest3...> &d) {
        ...
        if (which_variant==0) {
            auto tmp = contraction<Index<Idx0...>,Index<Idx1...>,Index<Idx2...>>(a,b,c);
            return contraction<resulting_index_0,Index<Idx3...>>(tmp,d);
        }
        else if (which_variant==1) {
            auto tmp = contraction<Index<Idx0...>,Index<Idx1...>,Index<Idx3...>>(a,b,d);
            return contraction<Index<Idx2...>,resulting_index_1>(c,tmp);
        }
        else if (which_variant==2) {
            auto tmp = contraction<Index<Idx0...>,Index<Idx2...>,Index<Idx3...>>(a,c,d);
            return contraction<Index<Idx1...>,resulting_index_2>(b,tmp);
        }
        else {
            auto tmp = contraction<Index<Idx1...>,Index<Idx2...>,Index<Idx3...>>(b,c,d);
            return contraction<Index<Idx0...>,resulting_index_3>(a,tmp);
        }
...
//        return tmp3;
        ...
        if (which_variant==0) {
            auto tmp = contraction<Index<Idx0...>,Index<Idx1...>,Index<Idx2...>,Index<Idx3...>>(a,b,c,d);
            return contraction<resulting_index_0,Index<Idx4...>>(tmp,e);
        }
        else if (which_variant==1) {
            auto tmp = contraction<Index<Idx0...>,Index<Idx1...>,Index<Idx2...>,Index<Idx4...>>(a,b,c,e);
            return contraction<Index<Idx3...>,resulting_index_1>(d,tmp);
        }
        else if (which_variant==2) {
            auto tmp = contraction<Index<Idx0...>,Index<Idx1...>,Index<Idx3...>,Index<Idx4...>>(a,b,d,e);
            return contraction<Index<Idx2...>,resulting_index_2>(c,tmp);
        }
        else if (which_variant==3) {
            auto tmp = contraction<Index<Idx0...>,Index<Idx2...>,Index<Idx3...>,Index<Idx4...>>(a,c,d,e);
            return contraction<Index<Idx1...>,resulting_index_3>(b,tmp);
        }
        else {
            auto tmp = contraction<Index<Idx1...>,Index<Idx2...>,Index<Idx3...>,Index<Idx4...>>(b,c,d,e);
            return contraction<Index<Idx0...>,resulting_index_4>(a,tmp);
        }
  ...
  template<typename T, size_t ... Rest0, size_t ... Rest1, size_t ... Rest2, size_t ... Rest3, size_t ... Rest4, size_t ... Rest5>
    ...
    contract_impl(const Tensor<T,Rest0...> &a, const Tensor<T,Rest1...> &b,
        ...
        if (which_variant==0) {
            ...
            return contraction<resulting_index_0,Index<Idx5...>>(tmp,f);
        }
        else if (which_variant==1) {
            auto tmp = contraction<Index<Idx0...>,Index<Idx1...>,Index<Idx2...>,Index<Idx3...>,Index<Idx5...>>(a,b,c,d,f);
            return contraction<Index<Idx4...>,resulting_index_1>(e,tmp);
        }
        else if (which_variant==2) {
            auto tmp = contraction<Index<Idx0...>,Index<Idx1...>,Index<Idx2...>,Index<Idx4...>,Index<Idx5...>>(a,b,c,e,f);
            return contraction<Index<Idx3...>,resulting_index_2>(d,tmp);
        }
        else if (which_variant==3) {
            auto tmp = contraction<Index<Idx0...>,Index<Idx1...>,Index<Idx3...>,Index<Idx4...>,Index<Idx5...>>(a,b,d,e,f);
            return contraction<Index<Idx2...>,resulting_index_3>(c,tmp);
        }
        else if (which_variant==4) {
            auto tmp = contraction<Index<Idx0...>,Index<Idx2...>,Index<Idx3...>,Index<Idx4...>,Index<Idx5...>>(a,c,d,e,f);
            return contraction<Index<Idx1...>,resulting_index_4>(b,tmp);
        }
        else {
            auto tmp = contraction<Index<Idx1...>,Index<Idx2...>,Index<Idx3...>,Index<Idx4...>,Index<Idx5...>>(b,c,d,e,f);
            return contraction<Index<Idx0...>,resulting_index_5>(a,tmp);
        }
...
struct extractor_contract_7<Index<Idx0...>, Index<Idx1...>, Index<Idx2...>,
  ...
  template<typename T, size_t ... Rest0, size_t ... Rest1, size_t ... Rest2,
    ...
    contract_impl(const Tensor<T,Rest0...> &a, const Tensor<T,Rest1...> &b,
        ...
        auto tmp5 = contraction<resulting_index_4,Index<Idx6...>>(tmp4,g);
